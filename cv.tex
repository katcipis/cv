...
\begin{itemize}
  \item Scaling infrastructure from day one to expansion to 3 new countries in 3 months.
  \item Setup observability for infrastructure and application (GCP/Sentry/Datadog).
