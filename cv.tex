...
use of automated tests and code reviews to improve the quality
of the web scrappers, solving some serious issues with bad
quality on the captured data. The team was responsible for all
the development, from coding to deployment, including maintaning
